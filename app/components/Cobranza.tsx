...
export const DEUDORES: Deudor[] = [
  {
    ...
    esperadoClp: 34_503_373,
    pagadoClp: 21_461_084,
    deudaClp: 13_042_289,
    cumplimiento: 0.622,
    cuotasPagadas: "9 de 13 (6 anticipos + 3 de 7 rentas)",
    inicioFacturacion: "Anticipo: dic-2025 · Rentas: mar-2026",
    severidad: "grave",
    diagnostico:
      "SIN PAGOS NUEVOS al 11-sep-2026. Ni la histórica N°28 ni la provisoria N°29 traen transferencias de Puerta Patagonia posteriores al 10-ago; la histórica sí confirma ese pago de $3.211.365, que en la provisoria venía fechado fuera del corte. VENCIDO: $6.514.994 — la renta 4/36 (factura N°69, $3.252.266, vencida desde el 06-jul) y la renta 6/36 de agosto ($3.262.728, vencida desde el 05-sep por calendario, sin factura registrada). EN PLAZO: $6.527.295 — la renta 5/36 de julio, que recién se facturó el 06-sep (N°95, $3.262.252), y la renta 7/36 de septiembre ($3.265.043, sin factura). Deuda total: $13.042.289. El atraso en facturar juega en contra de CSL: la renta de julio no figura como vencida sólo porque su factura salió el 06-sep.",
    rentaTexto:
    ...
    detalleAtraso: [
      "Anticipos 1 a 6 ($1.983.334 c/u, facturas N°31/38/43/47/53/63): PAGADOS el 17-dic-2025, 20-feb, 11-jun, 10-jul, 13-jul y 03-ago-2026 — anticipo de $10MM + IVA cerrado. ✓",
      "Rentas 1/36 a 3/36: PAGADAS ($3.166.949 el 18-mar, $3.182.766 el 05-may y $3.211.365 el 10-ago-2026). ✓",
      "Renta 4/36 (factura N°69, 06-jun-2026, $3.252.266): IMPAGA, vencida desde el 06-jul-2026. Es la más antigua pendiente.",
      "Renta 5/36 de julio (factura N°95, emitida recién el 06-sep-2026, $3.262.252): impaga, EN PLAZO; pasa a vencida el 06-oct-2026.",
      "Renta 6/36 de agosto (06-ago-2026, $3.262.728): impaga y VENCIDA desde el 05-sep-2026 por calendario. No hay factura registrada: confirmar si se emitió.",
      "Renta 7/36 de septiembre (06-sep-2026, $3.265.043): impaga, EN PLAZO por calendario; sin factura registrada.",
      "Pagos recibidos a la fecha: $21.461.084 (6 anticipos + 3 rentas). Saldo VENCIDO: $6.514.994. Deuda total pendiente: $13.042.289.",
    ],
    notasInternas: [
      "✅ Recalculado el 11-sep-2026 contra facturas SII y cartolas N°21-29 (la N°28 ya en versión histórica).",
      ...
      "✅ Confirmado con la histórica N°28: el abono de $3.211.365 del 10-ago-2026 es real y corresponde a agosto.",
      "⚠️ La factura N°95 (06-sep) está cargada como renta de JULIO (cuota 5/36) y los datos lo respaldan: está valorizada a UF 40.837, un valor de julio, mientras las facturas emitidas el 05-sep a Vikingos y Barranco usan UF 40.880. Si es así, la renta de julio se facturó con dos meses de atraso. Confirmar contra el PDF de la factura.",
      "⚠️ Las rentas 6/36 (agosto) y 7/36 (septiembre) no tienen factura en el sistema. La plataforma ya cuenta la de agosto como vencida por calendario; si no se emitió, la mora exigible hoy es sólo la factura N°69 ($3.252.266).",
    ],
  },
  {
    id: "VK",
    ...
    esperadoClp: 37_279_159,
    pagadoClp: 34_781_969,
    deudaClp: 2_495_115,
    cumplimiento: 0.933,
    cuotasPagadas: "Anticipo + 6 de 7 rentas",
    inicioFacturacion: "Anticipo: ene-2026 · Rentas: abr-2026",
    severidad: "leve",
    diagnostico:
      "AL DÍA al 11-sep-2026 — sin deuda vencida. La cartola N°29 trae el pago de la renta de agosto (cuota 6/24, factura N°88, $2.492.979): $2.492.307 el 02-sep, dos días antes de vencer. La diferencia de $672 queda bajo el umbral de $5.000 que el sistema trata como redondeo. Lo único pendiente es la renta de septiembre (cuota 7/24, factura N°94, $2.495.115, emitida el 05-sep), en plazo hasta el 05-oct. Conciliado contra las facturas N°65/70/83/88/94 y las cartolas hasta la N°29.",
    rentaTexto:
    ...
    detalleAtraso: [
      ...
      "Cuotas 1/24 a 4/24 (facturas N°54/55/65/70): PAGADAS ($2.431.760 y $2.430.357 el 06-may; $2.452.817 el 12-may; $2.483.824 el 16-jun). ✓",
      "Cuota 5/24 (factura N°83, $2.492.307, emitida el 05-jul): PAGADA el 17-jul-2026. ✓",
      "Cuota 6/24 (factura N°88, $2.492.979, emitida el 05-ago): PAGADA el 02-sep-2026 con $2.492.307 — $672 menos, diferencia de redondeo bajo el umbral de $5.000. ✓",
      "Cuota 7/24 (factura N°94, $2.495.115, emitida el 05-sep): impaga, aún EN PLAZO; pasa a vencida el 05-oct-2026.",
    ],
    notasInternas: [
      ...
      "✅ Recalculado el 11-sep-2026 contra facturas SII y cartolas N°21-29. Corrige la lectura anterior: la factura N°83 era la renta de julio (cuota 5/24), no la de agosto.",
      "⚠️ En septiembre Vikingos transfirió el mismo monto de julio ($2.492.307) en vez del total de la factura N°88 ($2.492.979). Hoy es redondeo, pero si repiten un monto fijo mientras la UF sube, el desfase crece: conviene pedir que paguen el total de cada factura.",
    ],
  },
  {
    id: "F1",
    ...
    esperadoClp: 25_684_240,
    pagadoClp: 24_550_052,
    deudaClp: 1_134_188,
    cumplimiento: 0.956,
    cuotasPagadas: "18 de 20",
    inicioFacturacion: "21-Feb-2025",
    severidad: "leve",
    diagnostico: "SE REGULARIZA al 11-sep-2026. SCG pagó el 28-ago la cuota 18/48 (factura N°86) por el monto exacto, $1.048.908, ocho días después del vencimiento: desaparece la renta completa vencida que motivó la alerta de agosto. Queda VENCIDO sólo un arrastre histórico de $84.870 que el sistema imputa a la cuota 17/48 (factura N°81). La cuota 19/48 (factura N°92, $1.049.318) está en plazo hasta el 20-sep. El atraso de ocho días fue idéntico en ambas flotas y los dos pagos llegaron completos el mismo día: luce más como un corrimiento del ciclo de pago de SCG que como un problema de caja.",
    rentaTexto:
    ...
    detalleAtraso: [
      "Cliente con historial de pagos mensuales durante todo 2025 y 2026.",
      "Cuota 17/48 (factura N°81, $1.047.650): pagada en dos parcialidades el 27 y 28-jul-2026; el sistema imputa ahí un arrastre histórico de $84.870 que sigue pendiente.",
      "Cuota 18/48 (factura N°86, $1.048.908, emitida el 21-jul): PAGADA el 28-ago-2026 por el monto exacto, ocho días después del vencimiento. ✓",
      "Cuota 19/48 (factura N°92, $1.049.318, emitida el 21-ago): impaga, aún EN PLAZO; pasa a vencida el 20-sep-2026.",
      "Saldo VENCIDO al 11-sep-2026: $84.870 (arrastre). Saldo total pendiente: $1.134.188.",
      "Cumplimiento actual: 95,6% del facturado.",
    ],
    notasInternas: [
      ...
      "✅ Recalculado el 11-sep-2026 con la histórica N°28: el pago del 28-ago cierra la cuota 18/48. El identificador lo asignó a esta flota por monto, sin necesidad de imputación manual.",
    ],
  },
  {
    id: "F2",
    ...
    repLegal: "Cristian Eduardo Allende Tapia",
    emailRepLegal: "cristian.allende@scg.cl",
    esperadoClp: 17_374_293,
    pagadoClp: 16_450_912,
    deudaClp: 923_381,
    cumplimiento: 0.947,
    cuotasPagadas: "14 de 15",
    inicioFacturacion: "21-Jun-2025",
    severidad: "leve",
    diagnostico: "SE REGULARIZA al 11-sep-2026. SCG pagó el 28-ago la cuota 14/48 (factura N°87) por el monto exacto, $923.020, ocho días después del vencimiento — el mismo día y con el mismo atraso que la Flota 1. Este contrato queda sin nada vencido. La cuota 15/48 (factura N°93, $923.381) está en plazo hasta el 20-sep.",
    rentaTexto:
    ...
    detalleAtraso: [
      ...
      "Cuota 14/48 (factura N°87, $923.020, emitida el 21-jul): PAGADA el 28-ago-2026 por el monto exacto, ocho días después del vencimiento. ✓",
      "Cuota 15/48 (factura N°93, $923.381, emitida el 21-ago): impaga, aún EN PLAZO; pasa a vencida el 20-sep-2026.",
      "Saldo VENCIDO al 11-sep-2026: $0. Saldo total pendiente: $923.381.",
      "Cumplimiento actual: 94,7% del facturado.",
    ],
    notasInternas: [
  ...
  },
  {
    ...
    esperadoClp: 1_904_000,
    pagadoClp: 1_000_000,
    deudaClp: 904_000,
    cumplimiento: 0.525,
    cuotasPagadas: "2 de 4 (la 3ª con pago parcial)",
    inicioFacturacion: "01-Jun-2026",
    severidad: "leve",
    diagnostico: "PRIMER PAGO al 11-sep-2026. La cartola N°29 registra la primera transferencia de Trongkai: $1.000.000 el 11-sep, a cuenta de la factura N°91 ($1.428.000, cuotas 1 a 3). El sistema la aplica a las cuotas 1/8 y 2/8 completas y $48.000 a la 3/8, así que quedan $428.000 de esa factura, en plazo hasta el 16-sep. Nada está vencido. Sigue abierto el problema de facturación: la cuota 4/8 de septiembre ($476.000) ya corre según contrato pero no tiene factura emitida.",
    rentaTexto:
    ...
    detalleAtraso: [
      ...
      "Factura N°91 (17-ago-2026): $1.428.000 IVA incluido. Cubre las cuotas 1, 2 y 3 de 8 en un solo documento.",
      "Pago del 11-sep-2026: $1.000.000 — cubre las cuotas 1/8 y 2/8 ($476.000 c/u) y $48.000 de la 3/8. ✓",
      "Saldo de la factura N°91: $428.000, EN PLAZO; pasa a vencido el 16-sep-2026.",
      "Cuota 4/8 (septiembre, $476.000): programada desde el 01-sep, SIN FACTURA emitida.",
      "Saldo VENCIDO al 11-sep-2026: $0. Saldo total pendiente: $904.000.",
    ],
    notasInternas: [
      ...
      "✅ 11-sep-2026: primer pago recibido, por un monto redondo ($1.000.000) y no por el total de la factura. Confirmar si el saldo de $428.000 viene en camino.",
    ],
  },
  {
    id: "BA",
    ...
    esperadoClp: 183_267_267,
    pagadoClp: 175_690_952,
    deudaClp: 7_576_315,
    cumplimiento: 0.959,
    cuotasPagadas: "Pago inicial + 4 de 5 cuotas (la 5ª en plazo)",
    inicioFacturacion: "Pago inicial: 01-may-2026 · Cuotas: 05-may-2026",
    severidad: "leve",
    diagnostico:
      "AL DÍA al 11-sep-2026 — sin deuda vencida. El pago inicial (factura N°58, $145.563.464) y las cuotas 1 a 4 están pagadas por el monto exacto. La cuota 5/24 (factura N°96, $7.576.315, emitida el 05-sep) todavía no aparece en la cartola N°29, pero está en plazo hasta el 05-oct y no es inusual: la cuota de mayo la pagaron a los 27 días. Sigue siendo, con diferencia, el mejor pagador de la cartera.",
    rentaTexto:
    ...
    detalleAtraso: [
      ...
      "Cuota 5/24 septiembre 2026 (factura N°96, $7.576.315, emitida el 05-sep): impaga, aún EN PLAZO; pasa a vencida el 05-oct-2026.",
    ],
    notasInternas: [
      ...
      "El contrato fija cuotas anticipadas en los primeros 5 días del mes, pero la plataforma mide la mora a 30 días desde la factura, igual que en el resto de la cartera. Con el criterio contractual estricto, la cuota 5/24 ya estaría atrasada.",
    ],
  },
  {
    id: "AX",
    ...
    esperadoClp: 8_925_000,
    pagadoClp: 8_925_000,
    deudaClp: 0,
    cumplimiento: 1.0,
    cuotasPagadas: "Pago inicial pagado · rentas desde nov-2026",
    inicioFacturacion: "Pago inicial: 30-jun-2026 · Cuotas: 05-nov-2026",
    severidad: "leve",
    diagnostico:
      "AL DÍA al 11-sep-2026 — deuda $0. La única factura emitida es la del pago inicial (N°79, $8.925.000), pagada el 27-jul-2026 en dos transferencias de $5.000.000 y $3.925.000 que suman el monto exacto. Las rentas todavía no se facturan: con el contrato Rev 1, las 48 cuotas corren desde el 05-nov-2026. La lectura anterior, que mostraba dos rentas vencidas, se apoyaba en las facturas N°77 y N°78, que se eliminaron del sistema por instrucción de CSL.",
    rentaTexto:
      "Pago inicial: $7.500.000 neto + IVA · Renta mensual: 22,66 UF + IVA × 48 cuotas (primeros 5 días de cada mes desde nov-2026, contrato Rev 1)",
    detalleAtraso: [
      "Pago inicial (factura N°79, 30-jun-2026): $8.925.000 — PAGADO el 27-jul-2026 ($5.000.000 + $3.925.000). ✓",
      "Rentas: 48 cuotas de 22,66 UF + IVA desde el 05-nov-2026 (contrato Rev 1). Ninguna facturada aún.",
      "Saldo VENCIDO al 11-sep-2026: $0. Saldo total pendiente: $0.",
    ],
    notasInternas: [
      ...
      "✅ Corregido el 11-sep-2026: las facturas N°77 y N°78 (cuotas 1 y 2 de jun-2026) se eliminaron por instrucción de CSL y el inicio de cuotas pasó a noviembre 2026 (contrato Rev 1). La ficha seguía mostrando esa mora, que ya no existe.",
    ],
  },
];
